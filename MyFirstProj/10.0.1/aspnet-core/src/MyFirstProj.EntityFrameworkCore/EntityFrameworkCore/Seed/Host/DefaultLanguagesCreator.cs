...
namespace MyFirstProj.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly MyFirstProjDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = MyFirstProjConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(MyFirstProjDbContext context)
    {
        _context = context;
    }
