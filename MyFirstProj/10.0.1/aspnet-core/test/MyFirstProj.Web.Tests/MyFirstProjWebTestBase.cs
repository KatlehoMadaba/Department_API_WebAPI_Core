...
namespace MyFirstProj.Web.Tests;

public abstract class MyFirstProjWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MyFirstProjWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyFirstProjWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MyFirstProjDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MyFirstProjDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MyFirstProjDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MyFirstProjDbContext, Task<T>> func)
    {
        T result;
